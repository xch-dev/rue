    ...
    pub fn new(source: Source, tokens: Vec<Token>) -> Self {
        ...
        for token in tokens {
            let kind = match token.kind {
                ...
                TokenKind::Is => T![is],
                TokenKind::As => T![as],
                TokenKind::BlsPairingIdentity => T![bls_pairing_identity],
                TokenKind::BlsVerify => T![bls_verify],
                TokenKind::Secp256K1Verify => T![secp256k1_verify],
                TokenKind::Secp256R1Verify => T![secp256r1_verify],
